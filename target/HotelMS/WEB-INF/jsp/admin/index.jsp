...
<head>
    ...
    <title>HotelMS Admin</title>
<body>
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl">
            <span class="logo navbar-slogan f-l mr-10 hidden-xs"> <h4>Hotel Management System </h4></span>
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    <li><i class="Hui-iconfont">&#xe62d;</i>  管理员</li>
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A">${ADMIN.admin_name} <i class="Hui-iconfont">&#xe6d5;</i></a>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a data-href="/user/list" data-title="用户列表" >用户列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a data-href="/roomList" data-title="房间列表" >房间信息</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-member2">
            ...
            <dd>
                <ul>
                    <li><a data-href="/staffList" data-title="员工列表" href="javascript:;">员工列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-article">
